// Include file 
#ifndef MONO_DIRECT_COMMON_HPP  // Header guard to prevent multiple inclusions
#define MONO_DIRECT_COMMON_HPP
...
class MonocularDirectMode : public rclcpp::Node
{   
    ...
    ~MonocularDirectMode(); // Destructor
